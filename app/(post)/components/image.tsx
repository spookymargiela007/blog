  ...
  if (isDataImage) {
    ...
    if (width === null || height === null) {
      ...
      if (src.startsWith("http")) {
        const arrayBuffer: ArrayBuffer = await fetch(src).then(res => res.arrayBuffer());
        ...
        if (
          ...
          const arrayBuffer: ArrayBuffer = await fetch("https://" + process.env.VERCEL_URL + src).then(res =>
            res.arrayBuffer()
          );
          imageBuffer = Buffer.from(arrayBuffer);
        } else {
